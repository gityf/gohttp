...
func (SimpleServerH *SimpleServerHandler) ServeHTTP(w http.ResponseWriter, r *http.Request) {
	var logId int64
...
func (SimpleServerH *SimpleServerHandler) Close() {
	SimpleServerH.wg.Wait()
}
